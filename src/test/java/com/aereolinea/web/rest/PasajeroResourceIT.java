...
import static com.aereolinea.domain.PasajeroAsserts.*;
import static com.aereolinea.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.aereolinea.domain.Pasajero;
import com.aereolinea.repository.PasajeroRepository;
...
class PasajeroResourceIT {
    ...
    void partialUpdatePasajeroWithPatch() throws Exception {
        ...
        partialUpdatedPasajero.nombre(UPDATED_NOMBRE).email(UPDATED_EMAIL).fechaNacimiento(UPDATED_FECHA_NACIMIENTO);
