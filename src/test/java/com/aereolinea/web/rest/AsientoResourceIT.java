...
import static com.aereolinea.domain.AsientoAsserts.*;
...
import com.aereolinea.domain.Asiento;
import com.aereolinea.repository.AsientoRepository;
...
class AsientoResourceIT {
    ...
    void partialUpdateAsientoWithPatch() throws Exception {
        ...
        partialUpdatedAsiento.numero(UPDATED_NUMERO).clase(UPDATED_CLASE);
